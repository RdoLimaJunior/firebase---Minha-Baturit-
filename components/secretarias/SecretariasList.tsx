  ...
  <Card className="flex flex-col items-center text-center">
    ...
    <div className="mt-2">
        <p className="text-md font-semibold text-slate-700 flex items-center justify-center space-x-1">
            ...
            <Icon name="check_circle" className="text-[var(--color-accent-green)] text-base" />
        </p>
    ...
    <div className="mt-6 border-t border-slate-200 pt-4 w-full flex flex-wrap gap-2 justify-center">
      {secretaria.link && (
          <a 
            href={secretaria.link} 
            target="_blank" 
            rel="noopener noreferrer" 
            className="inline-flex items-center justify-center px-2.5 py-1.5 text-sm rounded-lg font-semibold transition-colors bg-slate-200 text-slate-800 hover:bg-slate-300"
          >
              Mais informações
          </a>
      )}
